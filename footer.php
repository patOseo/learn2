...
<footer class="footer">
    ...
    <div class="container-xl foot-contact">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 mx-5 mb-4 mb-md-0 text-center"> 
                <a href="/contact/" class="mb-4 cta d-inline-flex text-uppercase">Contact Us</a>

                <div class="row">
                    <div class="col-lg-6">
                        <p class="h5 text-white">
                            <strong class="text-uppercase">Call Us:</strong><br><a href="tel:1-877-453-2762">1-877-453-2762</a>
                        </p>
                    </div>
                    <div class="col-lg-6">
                        <p class="h5 text-white">
                            <strong class="text-uppercase">Email:</strong><br><a href="mailto:contact@learn2.com">contact@learn2.com</a><br>
                        </p>
                    </div>
            ...
            <div class="mx-5 col-md-4">
                <a href="/program/" class="mb-4 d-block text-uppercase cta text-center">Team Building</a>
                <a href="/leadership-development/" class="mb-4 d-block text-uppercase cta text-center">Leadership Development</a>
                <a href="/communication-skills-training/" class="mb-4 d-block text-uppercase cta text-center">Communication Skills Training</a>
            </div>
        </div>
    </div>
    <?php endif; ?>
