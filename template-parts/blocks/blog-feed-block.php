					...
					<div class="col-md-<?php echo $columns; ?>">
		                <div class="box position-relative d-flex flex-column h-100 justify-content-between">
		                    ...
		                    <div class="copy d-flex flex-column flex-grow-1 justify-content-between">
		                       ...
		                       <button class="align-items-center cta d-flex justify-content-center lightblue text-uppercase text-white mt-4" aria-label="Read More About <?php the_title(); ?>">read more</button>
		                    </div>
		                </div>
			        </div>
				<?php endwhile; ?>
